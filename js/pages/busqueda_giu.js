document.addEventListener("DOMContentLoaded", function () {
    ...
    const filtros = [ano, tipo].filter(Boolean);
    ...
    if(filtros.some(filtro => estado[filtro.id])) {
        ...
        menuPadre.setAttribute('style', 'position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(63.6667px, 67.6667px);');
